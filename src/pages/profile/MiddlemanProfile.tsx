    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <form className="space-y-6 max-w-lg mx-auto bg-white p-8 rounded shadow">
        ...
        <div>
          ...
          <input className="w-full border rounded p-2" type="text" placeholder="Your expertise" />
        </div>
        <div>
          <label className="block mb-2 font-semibold">Phone</label>
          <input className="w-full border rounded p-2" type="text" placeholder="Your phone number" />
        </div>
        <hr className="my-6" />
        <div>
